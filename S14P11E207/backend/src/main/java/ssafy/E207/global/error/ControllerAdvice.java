package ssafy.E207.global.error;
...
import ssafy.E207.domain.auth.dto.response.NeedRegistrationResponse;
...
import ssafy.E207.global.error.exception.*;
...
//        logError("VALIDATION", HttpStatus.BAD_REQUEST, e, request);
	...
	// 400, InvalidRoomException
	@ExceptionHandler({ InvalidRoomException.class })
	@ResponseStatus(HttpStatus.BAD_REQUEST)
	public ResTemplate<?> handleInvalidRoom(RuntimeException e, HttpServletRequest request) {
		return createErrorResponse(e, HttpStatus.BAD_REQUEST);
	}

	// 400, ElectronNeededException
	@ExceptionHandler({ ElectronNeededException.class })
	@ResponseStatus(HttpStatus.BAD_REQUEST)
	public ResTemplate<?> handleElectronNeeded(RuntimeException e, HttpServletRequest request) {
...
//        logError("NOT_FOUND", HttpStatus.NOT_FOUND, e, request);
	...
	// 404, NotFoundUserException
	@ExceptionHandler({ NotFoundUserException.class })
	@ResponseStatus(HttpStatus.NOT_FOUND)
	public ResTemplate<?> handleNotFoundUser(RuntimeException e, HttpServletRequest request) {
		return ResTemplate.error(HttpStatus.BAD_REQUEST, e.getMessage());
	}

	// 404, NotFoundRoomException
	@ExceptionHandler({ NotFoundRoomException.class })
	@ResponseStatus(HttpStatus.NOT_FOUND)
	public ResTemplate<?> handleNotFoundRoom(RuntimeException e, HttpServletRequest request) {
		return ResTemplate.error(HttpStatus.BAD_REQUEST, e.getMessage());
	}
...
//        logError("SYSTEM", HttpStatus.INTERNAL_SERVER_ERROR, e, request);
	...
	// TODO: OpenViduJavaClientException,
